...
class armadaPage extends StatefulWidget {
 ...
 armadaPage({required this.camera});

  @override
  _armadaPageState createState() => _armadaPageState();
}
...
class _armadaPageState extends State<armadaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('armada'),
        backgroundColor: Color.fromARGB(255, 5, 112, 37),
      ),
      body: Container(
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  '¡Bienvenido a la Página de la Fuerza Armada!',
