...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: procuraduriaPage(camera: camera),
    );
  }
}
...
class procuraduriaPage extends StatefulWidget {
 ...
 procuraduriaPage({required this.camera});

  @override
  _procuraduriaPageState createState() => _procuraduriaPageState();
}
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  '¡Bienvenido a la Página de la Procuraduria!',
