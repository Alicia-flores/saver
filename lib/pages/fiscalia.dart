...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: fiscaliaPage(camera: camera),
    );
  }
}

class fiscaliaPage extends StatefulWidget {
  final CameraDescription camera;

 fiscaliaPage({required this.camera});

  @override
  _fiscaliaPageState createState() => _fiscaliaPageState();
}

class _fiscaliaPageState extends State<fiscaliaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('fiscalia'),
        backgroundColor: Color.fromARGB(255, 74, 94, 211),
      ),
      body: Container(
        ...
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  '¡Bienvenido a la Página de la Fiscalia general de la republica!',
